...
expect_equivalent(
  ...
  info = "sc_col_elements counts (also NA) correctly")
expect_equivalent(
...
expect_equivalent(
  ...
  data.table::data.table(n = 4,
                         n_fail = 0:2,
                         n_na = 0),
  info = "sc_cols_non_NA counts correctly all columns")
...
expect_equivalent(
  ...
  info = "sc_cols_non_NA correct meta information"
)
...
expect_error(sc_cols_non_NA(object = d, cols = c("d", "e")),
             pattern = msg_regexp,
             info = "call_back functionality works")
expect_warning(
...
expect_equivalent(
  ...
  info = "sc_cols_unique extract examples correctly"
)
...
expect_equivalent(
  ...
  info = "sc_left_join correct meta information"
)
expect_equivalent(
