...
#'     are displayed.}
#'   \item{fail_vec_str}{this captures how the actual logical vector of fails was
#'     build}
#'   \item{param_name}{usually generated by the convenience functions and it also
#'     may be a composition of more than one parameter name. However this parameter
#'     could also have been provided by the user}
#'   \item{call}{character of the call where the sanity check happend}
#'   \item{example}{if a check failed and the table is available, then some examples
#'     of rows that lead to the fail are stored here}
#' }
